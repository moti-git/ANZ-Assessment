...
public class CurrencyExchangeInverseCalculationHandler implements CurrencyExchangeHandler {
	...
	public CurrencyConversionBean convertCurrency(CurrencyConversionBean currencyConversionBean, String[][] materix,
		  ...
		  if (materixMapValue == "Inv") {
			  CurrencyCalculationStrategy calulationStrategy = CurrencyCalculationStrategyFactory.getStrategy(CurrencyInverseCalculationStrategyImpl.class);
